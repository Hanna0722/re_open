...
(function () {
  ...
  var css = [
    ...
    '.bbd-sec-title{height:38px;padding:0 16px;display:flex;align-items:center;background:#F5F6F8;color:#7D8796;font-size:12px;font-weight:700;line-height:12px}',
    ...
    '.user-name-strong{display:block;color:#111827;font-size:14px;font-weight:400;line-height:14px}',
