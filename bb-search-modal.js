...
(function () {
  ...
  var css = [
    ...
    '.bbsm-wrap .bbh-search{position:relative;flex:1 1 auto;min-width:0;border-color:#ff2f59;border-radius:8px;overflow:hidden;background:#f4f6f9}',
    ...
    '.bbsm-bar-chip{position:absolute;left:8px;top:50%;height:26px;transform:translateY(-50%);padding:0 10px;border-radius:8px;background:#f62f58;color:#fff;font-size:12px;font-weight:900;display:inline-flex;align-items:center;gap:4px;white-space:nowrap;max-width:40%;overflow:hidden;z-index:2;pointer-events:none;border:0;font-family:inherit}',
    ...
    '.bbsm-scope{height:40px;padding:0 8px;border:1px solid #dfe4ec;border-radius:8px;background:#fff;color:#707783;font-size:12px;font-weight:500;display:flex;flex-direction:row;align-items:center;justify-content:center;gap:6px;cursor:pointer;font-family:inherit;white-space:nowrap}',
