...
(function () {
  ...
  var DRAWER_CSS = [
    ...
    ":root{--font-sans:'Pretendard','Malgun Gothic','돋움','Dotum',Arial,sans-serif;--font-num:Roboto,var(--font-sans);--tp:#1A1A2E;--ts:#666680;--tm:#999BAA}",
    ...
    '.bbd-cs-actions button{height:34px;border:1px solid #E0E4EB;border-radius:5px;background:#fff;color:#1f2530;font-size:12px;font-weight:700;font-family:inherit}',
    ...
    '.user-drawer-head{padding:38px 14px 12px;background:#fff8f5;border-bottom:1px solid #E0E4EB}',
    ...
    '.user-asset-box strong{display:block;color:var(--tp);font-size:16px;font-weight:600}',
    ...
    '.user-menu-item .chev{margin-left:auto;color:var(--tm);font-weight:500;font-size:17px;line-height:1}',
    ...
    '.user-menu-item.logout{margin-top:6px;border-top:1px solid #E0E4EB;color:var(--tm);font-weight:600}'
  ].join('\n');
  ...
  var HEADER_CSS = [
    ...
    'header.topbar{display:block;background:#fff;border-bottom:1px solid #E0E4EB;padding:10px 16px 12px;position:sticky;top:0;left:auto;right:auto;bottom:auto;transform:none;width:auto;max-width:none;z-index:900;box-shadow:0 1px 0 rgba(32,36,43,.04)}',
