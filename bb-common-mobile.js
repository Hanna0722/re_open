...
(function () {
  ...
  var DRAWER_CSS = [
    ...
    '.user-member-row{display:flex;align-items:center;gap:12px;margin:0 -16px;padding:0 16px 12px;border-bottom:1px solid var(--border)}',
    ...
    '.user-stat-title{padding:10px 16px 10px;font-size:14px;font-weight:700;color:var(--tp);background:#fff}',
    '.user-asset-split{display:grid;grid-template-columns:1fr 1fr;padding:15px 0 6px;background:linear-gradient(180deg,#FFF9F9,#fff)}',
  ...
  function leftDrawerHTML() {
    ...
    return (
      ...
      '<nav class="user-menu-list">' +
        ...
        userMenuSection('fa-headset', '고객센터', 'mm-menu-cs',
          userMenuLink('사용자메모', 'mobile_user_memo.html') +
          userMenuLink('1:1문의내역', 'mobile_qna.html') +
          userMenuLink('1:1문의하기', 'mobile_qna_form.html')) +
        userMenuSection('fa-comments', '커뮤니티', 'mm-menu-community',
