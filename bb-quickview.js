...
(function () {
  ...
  var css = [
    ...
    '.qv-thumb{flex:0 0 auto;width:60px;height:60px;padding:0;border:1px solid #E0E4EB;border-radius:8px;overflow:hidden;background:none;cursor:pointer}',
    ...
    '.qv-btn{flex:1;height:44px;border-radius:8px;border:1px solid #1A3C6E;background:#fff;color:#1A3C6E;font:inherit;font-size:14px;font-weight:800;cursor:pointer}',
